...
use crate::resource::project_resource::DEFAULT_EFFECT_MATERIAL_INSTANCE_NAME;
...
impl EffectInstance {
    pub fn create_effect_instance(
        project_effect_manager: *const ProjectEffectManager,
        effect_id: i64,
    ...
    pub fn get_project_effect_manager_mut(&self) -> &mut ProjectEffectManager {
        unsafe { &mut *(self._project_effect_manager as *mut ProjectEffectManager) }
    }
