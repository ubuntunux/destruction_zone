...
impl FFTOcean {
    ...
    pub fn prepare_framebuffer_and_descriptors(&mut self, project_renderer: &ProjectRenderer, resources: &Resources) {
        ...
        // fft Variance
        let material_instance = resources.get_material_instance_data("fft_ocean/render_fft_ocean").borrow();
    ...
    pub fn compute_slope_variance_texture(
        ...
        // fft variance
        let material_instance_data = resources.get_material_instance_data("fft_ocean/render_fft_ocean").borrow();
    ...
    pub fn simulate_fft_waves(
        ...
        // fft a generate mips
        let material_instance_data = resources.get_material_instance_data("common/downsampling").borrow();
    ...
    pub fn render_ocean(
        ...
        renderer_data.render_material_instance(command_buffer, swapchain_index, "fft_ocean/render_fft_ocean", "render_fft_ocean/render_fft_ocean", &fft_grid, None, None, Some(&push_constant));
    }
}