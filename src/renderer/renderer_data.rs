...
impl RendererData_Bloom {
    pub fn initialize(
        ...
        let render_bloom_material_instance = resources.get_material_instance_data("common/render_bloom").borrow();
        ...
        let render_gaussian_blur_material_instance = resources.get_material_instance_data("common/render_gaussian_blur").borrow();
...
impl RendererData_TAA {
    pub fn initialize(
        ...
        let render_copy_material_instance = resources.get_material_instance_data("common/render_copy").borrow();
...
impl RendererData_SSAO {
    pub fn initialize(
        ...
        let render_gaussian_blur_material_instance = resources.get_material_instance_data("common/render_ssao_blur").borrow();
...
impl RendererData_HierachicalMinZ {
    pub fn initialize(
        ...
        let generate_min_z_material_instance = resources.get_material_instance_data("common/generate_min_z").borrow();
...
impl RendererData_SSR {
    pub fn initialize(
        ...
        let render_copy_material_instance = resources.get_material_instance_data("common/render_ssr_resolve").borrow();
...
impl RendererData_CompositeGBuffer {
    pub fn initialize(
        ...
        let render_copy_material_instance = resources.get_material_instance_data("common/composite_gbuffer").borrow();
        let pipeline_binding_data = render_copy_material_instance.get_default_pipeline_binding_data();
...
impl RendererData_ClearRenderTargets {
    pub fn initialize(
        ...
        let material_instance = resources.get_material_instance_data("common/clear_render_target").borrow();
...
impl RendererData_LightProbe {
    pub fn initialize(
        ...
        let material_instance = resources.get_material_instance_data("precomputed_atmosphere/precomputed_atmosphere").borrow();
