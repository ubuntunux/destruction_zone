...
impl ProjectRendererBase for ProjectRenderer {
    ...
    fn prepare_framebuffer_and_descriptors(&mut self, device: &Device, resources: &Resources) {
        ...
        if self.get_renderer_data().get_use_ray_tracing() {
            ...
            let material_instance = resources.get_material_instance_data("system/ray_tracing/ray_tracing").borrow();
    ...
    fn render_scene(
        ...
        // clear gbuffer
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/clear_framebuffer", "clear_gbuffer/clear", &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);

        // render shadow
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/clear_framebuffer", "clear_shadow/clear", &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
        ...
        if render_capture_height_map || self._is_first_rendering {
            renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/clear_framebuffer", "clear_capture_height_map/clear", &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
        ...
        // Render Final
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_final", DEFAULT_PIPELINE, &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
        ...
        if RenderTargetType::BackBuffer != self._debug_render_target {
            let mut render_debug_material_instance_data: RefMut<MaterialInstanceData> = resources.get_material_instance_data(&"system/common/render_debug").borrow_mut();
...
impl ProjectRenderer {
    ...
    pub fn clear_render_targets(
        ...
        let material_instance_data: Ref<MaterialInstanceData> = resources.get_material_instance_data("system/common/clear_render_target").borrow();
    ...
    pub fn copy_cube_map<T>(
        ...
        let copy_cube_map_material_instance = resources.get_material_instance_data("system/common/copy_cube_map").borrow();
    ...
    pub fn render_light_probe(
        ...
        let material_instance_data: Ref<MaterialInstanceData> = resources.get_material_instance_data("system/precomputed_atmosphere/precomputed_atmosphere").borrow();
        ...
        let downsampling_material_instance = resources.get_material_instance_data("system/common/downsampling").borrow();
        ...
        if application_constants::RENDER_OBJECT_FOR_LIGHT_PROBE {
            ...
            for i in 0..constants::CUBE_LAYER_COUNT {
                ...
                renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/clear_framebuffer", CLEAR_LIGHT_PROBE_PIPELINES[i], &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
    ...
    pub fn render_taa(
        ...
        // render_taa
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_taa", DEFAULT_PIPELINE, &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
        ...
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_copy", DEFAULT_PIPELINE, quad_geometry_data, framebuffer, descriptor_sets, Some(&push_constants));
    }
    ...
    pub fn render_bloom(
        ...
        let render_bloom_material_instance_data: Ref<MaterialInstanceData> = resources.get_material_instance_data("system/common/render_bloom").borrow();
        ...
        let render_gaussian_blur_material_instance_data: Ref<MaterialInstanceData> = resources.get_material_instance_data("system/common/render_gaussian_blur").borrow();
    ...
    pub fn render_ssr(&self, renderer_data: &RendererData, command_buffer: vk::CommandBuffer, swapchain_index: u32, quad_geometry_data: &GeometryData) {
        ...
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_ssr", DEFAULT_PIPELINE, &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
        ...
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_ssr_resolve", DEFAULT_PIPELINE, quad_geometry_data, framebuffer, descriptor_sets, NONE_PUSH_CONSTANT);
    }
    ...
    pub fn render_ssao(&self, renderer_data: &RendererData, command_buffer: vk::CommandBuffer, swapchain_index: u32, quad_geometry_data: &GeometryData) {
        // render ssao
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_ssao", DEFAULT_PIPELINE, quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
        ...
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_ssao_blur", DEFAULT_PIPELINE, quad_geometry_data, framebuffer_h, descriptor_sets_h, Some(&push_constants_blur_h));
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_ssao_blur", DEFAULT_PIPELINE, quad_geometry_data, framebuffer_v, descriptor_sets_v, Some(&push_constants_blur_v));
    }
    ...
    pub fn composite_gbuffer(&self, renderer_data: &RendererData, command_buffer: vk::CommandBuffer, swapchain_index: u32, quad_geometry_data: &GeometryData) {
        ...
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/composite_gbuffer", DEFAULT_PIPELINE, &quad_geometry_data, None, descriptor_sets, NONE_PUSH_CONSTANT);
    }
    ...
    pub fn generate_min_z(&self, renderer_data: &RendererData, command_buffer: vk::CommandBuffer, swapchain_index: u32, quad_geometry_data: &GeometryData) {
        ...
        // Copy Scene Depth
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/generate_min_z", "generate_min_z/render_copy", &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);

        // Generate Hierachical Min Z
        let material_instance_data: Ref<MaterialInstanceData> = resources.get_material_instance_data("system/common/generate_min_z").borrow();
    ...
    pub fn scene_color_downsampling(&self, command_buffer: vk::CommandBuffer, swapchain_index: u32, renderer_data: &RendererData) {
        let resources: Ref<Resources> = renderer_data._resources.borrow();
        let material_instance_data: Ref<MaterialInstanceData> = resources.get_material_instance_data("system/common/downsampling").borrow();
    ...
    pub fn render_post_process(
        ...
        // Motion Blur
        renderer_data.render_material_instance(command_buffer, swapchain_index, "system/common/render_motion_blur", DEFAULT_PIPELINE, &quad_geometry_data, None, None, NONE_PUSH_CONSTANT);
    }
}