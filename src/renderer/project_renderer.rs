...
impl ProjectRendererBase for ProjectRenderer {
    ...
    fn prepare_framebuffer_and_descriptors(&mut self, device: &Device, resources: &Resources) {
        ...
        if self.get_renderer_data().get_use_ray_tracing() {
            ...
            let material_instance = resources.get_material_instance_data("ray_tracing/ray_tracing").borrow();
...
impl ProjectRenderer {
    ...
    pub fn render_light_probe(
        ...
        let material_instance_data: Ref<MaterialInstanceData> = resources.get_material_instance_data("precomputed_atmosphere/precomputed_atmosphere").borrow();
