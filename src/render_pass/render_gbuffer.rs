...
pub fn get_render_pass_data_create_info(render_object_type: RenderObjectType, render_pass_data_create_info_map: &mut RenderPassDataCreateInfoMap) {
    ...
    pipeline_data_create_info._pipeline_data_create_info_name = String::from("render_object_test");
    pipeline_data_create_info._pipeline_vertex_shader_file = PathBuf::from("common/render_object.vert");
    pipeline_data_create_info._pipeline_fragment_shader_file = PathBuf::from("common/render_object.frag");
